# Ori Language Specification — Version 0.4
...
This repository contains the full **Ori v0.4 language specification**, divided into clearly defined sections:
...
## 🧩 Specification Scope (v0.4)

The v0.4 specification defines:
...
> **Ori v0.4 — A language built on clarity, precision, and developer intent.**
